 ...
 * @author Renato
 */
public class IW4PostUpdatedPlayerEvent extends Event {

    private final IW4Player player;
    private final HashMap<Object, IW4OrderProduct> orders;

    public IW4PostUpdatedPlayerEvent(IW4Player player, HashMap<Object, IW4OrderProduct> pending_orders) {
        this.player = player;
    ...
    public HashMap<Object, IW4OrderProduct> getUpdatedPackages() {
        return orders;
    }
